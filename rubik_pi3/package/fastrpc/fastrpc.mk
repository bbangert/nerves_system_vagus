...
# version RadxaOS ships, and the one the Q6A port's bring-up validated 3/3
# on `fastrpc_test -a v68` against its CDSP.HT.2.5.c3-00134 firmware set.
# Rubik Pi 3 carries the same pin against the CDSP.HT.2.5.c3-00134 set
# installed by package/rubik-pi3-firmware; fastrpc_test validation on this
# board is pending device bring-up.
#
...
# rubik-pi3-firmware installs the shells/skels. The stock compiled-in
