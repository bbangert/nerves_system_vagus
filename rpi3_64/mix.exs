defmodule NervesSystemRpi364.MixProject do
  use Mix.Project

  @github_organization "bbangert"
  @app :nerves_system_rpi3_64
  ...
  defp description do
    """
    Nerves System - Raspberry Pi 3 A+/B/B+ (64-bit)
    """
  end
  ...
  defp package do
    [
      ...
      links: %{
        "GitHub" => @source_url,
        "REUSE Compliance" =>
          "https://api.reuse.software/info/github.com/nerves-project/nerves_system_rpi3_64"
      }
    ]
  end
