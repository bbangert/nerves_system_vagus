...
-->
# Raspberry Pi 3 Model A+/B/B+ (64-bit)

[![Hex version](https://img.shields.io/hexpm/v/nerves_system_rpi3_64.svg "Hex version")](https://hex.pm/packages/nerves_system_rpi3_64)
[![CI](https://github.com/nerves-project/nerves_system_rpi3_64/actions/workflows/ci.yml/badge.svg)](https://github.com/nerves-project/nerves_system_rpi3_64/actions/workflows/ci.yml)
[![REUSE status](https://api.reuse.software/badge/github.com/nerves-project/nerves_system_rpi3_64)](https://api.reuse.software/info/github.com/nerves-project/nerves_system_rpi3_64)
...
> [nerves_system_rpi0_2](https://github.com/nerves-project/nerves_system_rpi0_2)
> (same BCM2837/Cortex-A53 SoC family, already aarch64), with Raspberry Pi
> 3-specific board bits (rpi-firmware variant, kernel DTBs, `config.txt`
> overlays, `boardid.config`, `fw_env.config`) ported from
> [nerves_system_rpi3](https://github.com/nerves-project/nerves_system_rpi3).
> See `CHANGELOG.md` for the exact list of what was inherited vs. ported.

This is the base Nerves System configuration for the Raspberry Pi 3 Model
A+/B/B+. It is similar to
[nerves_system_rpi3](https://github.com/nerves-project/nerves_system_rpi3)
...
| Feature              | Description                                                  |
| -------------------- | -------------------------------------------------------------|
| CPU                  | 1.2 GHz quad-core Cortex-A53 (ARMv8), running in 64-bit mode  |
| Memory               | 1 GB DRAM                                                     |
| Storage              | MicroSD                                                       |
...
nerves.new` and to export `MIX_TARGET=rpi3_64`. See the [Getting started
...
supports Bluetooth on the Raspberry Pi 3 using `ttyS0`. The details are
